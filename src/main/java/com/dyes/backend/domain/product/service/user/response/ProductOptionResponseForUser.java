...
@NoArgsConstructor
@AllArgsConstructor
public class ProductOptionResponseForUser {
    ...
    public ProductOptionResponseForUser(ProductOption productOption) {
    ...
    public List<ProductOptionResponseForUser> productOptionResponseList(List<ProductOption> productOptionList) {
        return productOptionList.stream()
                .map(ProductOptionResponseForUser::new)
