...
public class ProductResponseForAdmin {
    ...
    public ProductResponseForAdmin productResponseForAdmin(Product product) {
        return new ProductResponseForAdmin(product.getId(), product.getProductName(), product.getProductDescription(), product.getCultivationMethod(), product.getProductSaleStatus());
    }
}
